...
int inputPin = A5; //currently stretch
int inputPin2 = A6; //second stretch
...
void setup() {
  ...
  waveform1.begin(1, 100, WAVEFORM_TRIANGLE);
  waveform1.pulseWidth(0.15);
  waveform2.begin(1, 100, WAVEFORM_TRIANGLE);
  combine1.setCombineMode(AudioEffectDigitalCombine::XOR);
    waveform3.begin(1, 100, WAVEFORM_SINE);
  waveform3.pulseWidth(0.15);
  waveform4.begin(1, 100, WAVEFORM_SINE);
...
void loop() {
  ...
  delay(1);        // delay in between reads for stability
   ...
   float scaledPot = (((float)potValue -900) /180 )* 1000  ;
...
// waveform1.amplitude(0.8);
  waveform1.frequency(scaledPot - 300);
...
// subtract the last reading:
  ...
  int potValue2 = average2;
   int scaledPotStart2 = potValue2 - 800  ;
   float scaledPot2 = ((float)scaledPotStart2 / 200 ) * 600;

  
Serial.print("purple TENTACLE 2:");
Serial.println(scaledPot2); 
   
waveform2.frequency(scaledPot2 - 300);
